...
<left>
 ...
 <div class="flexsearch">
        <div class="flexsearch--wrapper">
            <form class="flexsearch--form" action="results.php" method="post">
                <div class="flexsearch--input-wrapper">
                    ...
                    <input class="flexsearch--input" type="text" name="name" placeholder="compare your confusion">
                </div>
    ...
    <header>
        ...
        <div class="camera_container">
            <div id="camera" class="camera_wrap">
                <div data-thumb="124.jpg" data-src="images/124.jpg">
                    <div class="camera_caption fadeIn">
                    </div>
                </div>
                <div data-thumb="new1.jpg" data-src="images/new1.jpg">
                    <div class="camera_caption fadeIn">
                    </div>
                </div>
                <div data-thumb="126.jpg" data-src="images/126.jpg">
                    <div class="camera_caption fadeIn">
                    </div>
                </div>
            </div>

            <form id="searchbox" action="results.php" method="post">
              <input id="search" type="text" name="name" placeholder="compare your confsion">
            ...
            <div class="brand wow fadeIn">
                <h1 class="brand_name">
                    ...
                    <a href="./">
                     ...
                     <p><font color="maroon">Priceshooter</font></p>
        ...
        <div class="toggle-menu-container">
            <nav class="nav">
                ...
                <ul class="sf-menu">
                    ...
                    <li>
                        <a href="index-2.html">Beauty and health</a>
                    </li>
                    <li>
                        <a href="index-3.html">More Products</a>
                    </li>
                    <li>
                        <a href="index-4.html">Contacts</a>
                        <ul>
                                    <li>
                                        <a href="#">E-mail: Priceshooter.info@gmail.com</a>
                                    </li>
    ...
    <footer>
        <div class="container">
            <ul class="socials">
                <li><a href="https://www.facebook.com/search/top/?q=svanucet"class="fa fa-facebook">   </a></li>
                <li><a href="#" class="fa fa-gmail"></a></li>
